...
define('wpintvl', type=float, default=5, help='Websocket ping interval')
define('timeout', type=float, default=15, help='SSH connection timeout')
...
def get_app_settings(options):
    settings = dict(
        ...
        static_url_prefix="/ci_webssh/static/"
    )
    return settings
...
XC_PASSPORT = "cc4188095f8d15c45d6"
XC_URL = "http://10.130.131.54:8888" # 星辰测试环境代理
